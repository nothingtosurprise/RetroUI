...
Check the [migration guide](https://retroui.dev/docs/migration) for any breaking changes (there are very few, and we've documented workarounds for all of them).
...
**Explore RetroUI 2.0:**
- [Browse Components](https://retroui.dev/components)
